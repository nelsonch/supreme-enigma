...
def create_model_specs_no_adstock(opt_tol=1e-6, opt_maxiter=1000, n_init=5, eta_sq=1.0):
    """Create 6 saturation function model specifications WITHOUT adstock estimation"""
    from mmm_class import MMM_NoAdstock
    
    models = {
        'Hill C-shape': MMM_NoAdstock('Hill C-shape', saturation_type='hill_c',
                           opt_tol=opt_tol, opt_maxiter=opt_maxiter, n_init=n_init, eta_sq=eta_sq),
        'Hill S-shape': MMM_NoAdstock('Hill S-shape', saturation_type='hill_s',
                           opt_tol=opt_tol, opt_maxiter=opt_maxiter, n_init=n_init, eta_sq=eta_sq),
        'Weibull C-shape': MMM_NoAdstock('Weibull C-shape', saturation_type='weibull_c',
                              opt_tol=opt_tol, opt_maxiter=opt_maxiter, n_init=n_init, eta_sq=eta_sq),
        'Weibull S-shape': MMM_NoAdstock('Weibull S-shape', saturation_type='weibull_s',
                              opt_tol=opt_tol, opt_maxiter=opt_maxiter, n_init=n_init, eta_sq=eta_sq),
        'Sigmoid': MMM_NoAdstock('Sigmoid', saturation_type='sigmoid',
                      opt_tol=opt_tol, opt_maxiter=opt_maxiter, n_init=n_init, eta_sq=eta_sq),
        'Erf': MMM_NoAdstock('Erf', saturation_type='erf',
                  opt_tol=opt_tol, opt_maxiter=opt_maxiter, n_init=n_init, eta_sq=eta_sq)
    }
